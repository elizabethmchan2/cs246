...
{
  int board5[5][5] =    { {O, X, BLANK, O, O},
                          {X, X, BLANK, O, O},
                          {BLANK, X, X, O, X},
                          {O, O, X, O, O},
                          {O, BLANK, X, O, X}   };
  ck_assert_int_eq(tic_tac_toe_winner(5, (int*)board5), O);

  int board4[4][4] =    { {O, O, X, O},
                          {X, X, O, BLANK},
                          {X, X, X, X},
                          {O, O, X, BLANK} };
  ck_assert_int_eq(tic_tac_toe_winner(4, (int*)board4), X);

  int board3[3][3] = { {O, O, X},
                       {X, X, O},
                       {X, O, X} };
